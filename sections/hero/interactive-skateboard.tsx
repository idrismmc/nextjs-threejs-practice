...
import Hotspot from "@/sections/hero/hotspot";
import { WavyPaths } from "@/sections/hero/wavy-paths";
      ...
      <group ref={originRef}>
        <group ref={containerRef} position={[-0.25, 0, -0.635]}>
          <group position={[0, -0.086, 0.635]}>
            <Skateboard
              deckTextureURL={deckTextureURL}
              deckTexturesURLs={[deckTextureURL]}
              wheelTextureURL={wheelTextureURL}
              wheelTexturesURLs={[wheelTextureURL]}
              truckColor={truckColor}
              boltColor={boltColor}
              constantWheelSpin
            />
